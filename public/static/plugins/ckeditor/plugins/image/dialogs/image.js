						...
						children: [ {
							...
							},
							{
								...
								onClick:function(e) {
									...
									var dialog = this.getDialog();
									//console.log("onClick..., filebrowserImageUrl="+editor.config.filebrowserImageUrl);
									var _self = this;
						            ...
						            layer.open({
						                ...
						                shift:10,
						                area: ['55%', '70%'],
						                content: editor.config.filebrowserImageUrl,
						                btn:['确定', '关闭'],
						                yes: function(index, layero) {
						                    ...
						                    var el = dialog.getContentElement( 'info', 'txtUrl' );
						                    el.setValue(row.url );

						                    if ( dialog.preview ) {
												// Query the preloader to figure out the url impacted by based href.
												previewPreloader.setAttribute( 'src', row.url );
												dialog.preview.setAttribute( 'src', previewPreloader.$.src );
												updatePreview( dialog );
											}

						                    //txtUrl.val(row.previewUrl);
