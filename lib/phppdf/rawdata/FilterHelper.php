...
class FilterHelper
{
    protected $availableFilters = array('ASCIIHexDecode', 'ASCII85Decode', 'LZWDecode', 'FlateDecode', 'RunLengthDecode');
     ...
     */
    public function decodeFilter($filter, $data, $decodeMemoryLimit = 0)
    {
        switch ($filter) {
            case 'ASCIIHexDecode':
     ...
     * @throws Exception
     */
    protected function decodeFilterASCIIHexDecode(string $data)
    {
     ...
     * @throws Exception
     */
    protected function decodeFilterASCII85Decode(string $data)
    {
     ...
     * @throws Exception
     */
    protected function decodeFilterFlateDecode($data, $decodeMemoryLimit)
    {
     ...
     * @param string $data Data to decode
     */
    protected function decodeFilterRunLengthDecode(string $data)
    {
        // initialize string to return
        $decoded = '';
        // data length
