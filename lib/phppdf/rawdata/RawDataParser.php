...
class RawDataParser
{
     ...
     */
    public function __construct($cfg = array(), Config $config = null)
    {
     ...
     * @throws Exception
     */
    protected function decodeStream($pdfData, array $xref, array $sdic, $stream)
    {
     ...
     * @throws Exception
     */
    protected function decodeXref($pdfData, $startxref, array $xref = array())
    {
        ...
        // get trailer data
        if (preg_match('/trailer[\s]*<<(.*)>>/isU', $pdfData, $matches, 
     ...
     */
    protected function decodeXrefStream($pdfData, $startxref, $xref = array())
    {
    ...
    protected function getObjectHeaderPattern(array $objRefs)
    {
    ...
    protected function getObjectHeaderLen(array $objRefs)
    {
        // "4 0 obj"
     ...
     */
    protected function getIndirectObject($pdfData, array $xref, $objRef, $offset = 0, $decoding = true)
    {
        /*
     ...
     * @throws Exception
     */
    protected function getObjectVal($pdfData, $xref, array $obj)
    {
        if ('objref' == $obj[0]) {
     ...
     */
    protected function getXrefData($pdfData, $offset = 0, $xref = array())
    {
        ...
        if (0 == $offset) {
            ...
            $startxref = $offset;
        } elseif (preg_match('/([0-9]+[\s][0-9]+[\s]obj)/i', 
			$pdfData, $matches, PREG_OFFSET_CAPTURE, $offset)) {
